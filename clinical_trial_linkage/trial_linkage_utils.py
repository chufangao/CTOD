...
def get_sub_search_group(target_trial_dict, phase_trials):
        ...
        target_intervention_type = [intervention_type.lower() for intervention_type in target_intervention_type]
        ...
        for trial in phase_trials:
            ...
            if trial_completion_date <= target_start_date:
                ...
                #convert to lower case
                trial_intervention_type = [intervention_type.lower() for intervention_type in trial_intervention_type]
                intersection_intervention_type = list(set(target_intervention_type).intersection(trial_intervention_type))
                # print(intersection_intervention_type)
