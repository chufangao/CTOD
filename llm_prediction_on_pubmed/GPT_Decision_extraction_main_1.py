...
from support_functions import extract_study_basic_info,parse_date,filter_articles,extract_similar_pubmed_articles

# read extracted pubmed_articles
pubmed_files = glob.glob('/home/jp65/CTOD/extracted_pubmed/*_pubmed_abs.json')
print(len(pubmed_files))
...
data_path = '/home/jp65/CTOD/data/studies.txt'
trial_basic_info = extract_study_basic_info(data_path, info_to_extract = ['official_title','start_date','completion_date'])
...
pubmed_df = pd.read_csv('/home/jp65/CTOD/results/top_2_extracted_pubmed_articles.csv')
print(len(pubmed_df))
...
for jsonfile in tqdm(pubmed_files):
    ...
    if len(new_rows) % 10000 == 0:
        ...
        pubmed_df.to_csv('/home/jp65/CTOD/results/top_2_extracted_pubmed_articles.csv', index = False)
pubmed_df = pd.DataFrame(new_rows)  
pubmed_df.to_csv('/home/jp65/CTOD/results/top_2_extracted_pubmed_articles.csv', index = False)
#     # break
